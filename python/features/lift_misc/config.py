...
task_arg.add_argument("--task", type=str, default="test",
                      choices=["train", "test"],
                      help="")
task_arg.add_argument("--subtask", type=str, default="joint",
...
test_arg.add_argument("--test_scl_intv", type=int, default=2, help="")
test_arg.add_argument("--test_min_scale_log2", type=int, default=1, help="")
test_arg.add_argument("--test_max_scale_log2", type=int, default=2, help="")
